...
createBillboard(
    -80, 2.5, -70,
    './src/jsm/zootopic.gif', 
    URL.terpsolutions,
    Math.PI * 0.22
);

//zoo 텍스트
    createTextOnPlane(-70, 0.002, -48,   './src/jsm/terp-solutions-text.png', 20, 40);
...
//poke 텍스트 2
    createTextOnPlane(-39, 0.04, -51,   './src/jsm/bagholderbets-text.png', 19, 39);
...
// 간사이 텍스트 3
    ...
    createTextOnPlane(-15, 0.002, -50,   './src/jsm/kansai-text.png', 20, 40);
...
createBillboard(
    -75, 2.5, 0,                                 // x, y, z 위치
    './src/jsm/OMU.png',                      // 사용할 이미지 경로
    "https://velog.io/@kys/3D%E3%83%9D%E3%83%BC%E3%83%88%E3%83%95%E3%82%A9%E3%83%AA%E3%82%AA%E4%BF%9D%E5%AD%98%E7%94%A8",               // 클릭 시 이동할 링크
    Math.PI * 0.16                               // 회전 각도
);
//OMU 설명 텍스트
    createTextOnPlane(-75, 0.01, 25,   './src/jsm/omu2.png', 20, 40);

//神戸리모트 간판 //고베 프로젝트1

createBillboard(
    -30, 2.5, 0,                                 // x, y, z 위치
    './src/jsm/神戸イメージ.png',                      // 사용할 이미지 경로
    "https://velog.io/@kys/%E3%83%97%E3%83%AD%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88-%E4%BF%9D%E5%AD%98%E7%94%A8",               // 클릭 시 이동할 링크
    Math.PI * 0.16                               // 회전 각도
);
// 고베 설명 텍스트
    createTextOnPlane(-25, 0.01, 25,   './src/jsm/神戸.png', 20, 40);
    ...
    createTextOnPlane(-14, 0.01, -49, inputText.OMU_txt, 20, 40);
...
createBox(
  ...
  4, 4, 1,
  boxTexture.LinkedIn,
  "https://www.linkedin.com/in/ys-k-38242831a/",
  0x000000,
  false
);
...
//allskills 에듀케이션
     allSkillsSection(62, 0.035, -45, 45, 65, boxTexture.allSkills);
    allSkillsSection(61, 0.025, 25, 40, 80, inputText.activities);

     allSkillsSection(61, 0.035, 30, 25, 25, inputText.education);
 //   allSkillsSection(61, 0.025, 25, 40, 80, inputText.education);
    ...
    if (isTouchscreenDevice()) {
      ...
      instructionsText = '   Use the joystick in the bwottom \nleft of the screen to move the ball.';
    } else {
      touchText = '';
      instructionsText = '';
    }
   ...
   //createTextOnPlane(63, 0.3, -45,   './src/jsm/allSkills.png', 40, 55);
    ...
    //simpleText(61, 0.04, -10, 'TIMELINE', 4);
