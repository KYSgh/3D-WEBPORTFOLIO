...
//box textures
let boxTexture = {};
boxTexture.Github = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm/githubLogo.png';
boxTexture.twitter = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm/twitter.png';
boxTexture.LinkedIn = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm/linkedInLogo.png';
boxTexture.mail = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm.png';
...
inputText.activities = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm/activities_text.png';
inputText.education = 'https://kysgh.github.io/3D-WEBPORTFOLIO/src/jsm/redhat2.png';

inputText.bagholderBetsText = '../src/jsm/bagholderbets-text.png';
//OMU
inputText.OMU_txt = "../src/jsm/OMU-txt.png"; 
inputText.homeSweetHomeText = '../src/jsm/kansai-text.png';
inputText.staticPortfolio = '../src/jsm/static-portfolio.png';
//神戸
inputText.神戸 = '../src/jsm/神戸.png';
...
//호스팅
URL.gitHub = 'https://github.com/KYSgh/3D-WEBPORTFOLIO';
//벨로그임
URL.twitter = 'https://velog.io/@kys/posts';
//링크드인임
URL.email = 'https://www.linkedin.com/in/ys-k-38242831a/';
//velogリンク
URL.githubBagholder = 'https://velog.io/@kys/%EC%96%BC%EA%B5%B4-%EB%AA%AC%EC%8A%A4%ED%84%B0'
//velogリンク
